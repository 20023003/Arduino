...
extern String PId = "wtadol200"; // THIS THE PRODUCT ID change if needed
char status[100];
...
void handlecurrentstatus(int relay1,int relay2)
{
...
void handlestatus(int relay1)
{
  StaticJsonDocument<2000> doc;
  doc["device1"] = relay1;
  serializeJson(doc, status);
  client.publish(topic1,status,false);
